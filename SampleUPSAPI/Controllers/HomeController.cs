...
namespace SampleUPSAPI.Web.Test.Controllers
{
    public class HomeController : Controller
    {
        ...
        public HomeController(ITrackService trackService, IShipmentService shipmentService, IVoidShipmentService voidShipmentService, ILabelRecoveryService labelRecoveryService, IPickupService pickupService, IOptions<UPSConfiguration> config)
        {
                    ...
                    Shipment = new ShipmentType
                    {
                        ...
                        Shipper = new ShipperType
                        {
                            ...
                            Address = new ShipAddressType
                            {
                                ...
                                //Length: 2…5
                                //Required: Cond
                                StateProvinceCode = _config?.ShipperConfiguration?.Shipper?.Address?.StateProvinceCode,
                        ...
                        Package = new PackageType[]
                        {
                            ...
                            new PackageType
                            {
                                ...
                                {
                                    Weight = "20",
                                    UnitOfMeasurement= new ShipUnitOfMeasurementType { Code = "LBS" }
                                },
                                ...
                                Dimensions = new DimensionsType
                                {
                                    ...
                                    Width = "20",
                                    Length = "60",
                                    UnitOfMeasurement = new ShipUnitOfMeasurementType { Code = "IN" }
                                },
        ...
        private IShipConfirmRequest ShipConfirmRequest
        {
            get
            {
                IShipConfirmRequest shipmentRequest = new ShipConfirmRequest()
                {
                    ...
                    {
                        Description = "Ship webservice example",
                        Shipper = _config?.ShipperConfiguration?.Shipper,
                        PaymentInformation = new PaymentInfoType
                        {
                            ShipmentCharge = new ShipmentChargeType[]
                            {
                        ...
                        ShipFrom = new ShipFromType
                        {
                            AttentionName = "Mr.ABC",
                            Name = "ABC Associates",
                            Address = _config?.ShipperConfiguration?.Shipper?.Address
                        },
                        ShipTo = new ShipToType
                        {
                            AttentionName = "DEF",
