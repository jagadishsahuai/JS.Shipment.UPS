...
namespace JS.Shipment.UPS.Model
{
    public class TrackRequest: ITrackRequest
	{
        ...
        public string IncludeMailInnovationIndicator { get; set; }
        /// <summary>
        ...
        /// </summary>
        public PickupDateRangeType PickupDateRange { get; set; }
        /// <summary>
        ...
        /// </summary>
        public ShipFromRequestType ShipFrom { get; set; }
        /// <summary>
        /// Container for the Destination Address to narrow the reference number search.
        /// </summary>
        public ShipToRequestType ShipTo { get; set; }
        /// <summary>
        ...
        /// </summary>
        public RefShipmentType ShipmentType { get; set; }
        public ShipperAccountInfoType ShipperAccountInfo { get; set; }
    }
}
